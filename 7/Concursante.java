...
public abstract class Concursante
{
	...
	{
		this.nominaciones=this.nominaciones+pCantidad;
	}
	...
	{
		int contador=0;
		while (contador<this.listaNominados.numeroConcursantes())
		{
			Concursante unConcursante=this.listaNominados.obtenerConcursanteEnPos(contador);
			this.aplicarNominacion(unConcursante);
			contador=contador+1;
		}
	}
